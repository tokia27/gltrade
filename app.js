  ...
  },
{
  ...
  },
  {
    ...
    "title": {
      ...
      "ru": "Корректирующий карандаш EH10590, DELI"
    },
    "price": 0.80,
    "inStock": true,
    "category": "stationery",
  ...
  },
  {
    ...
    "category": "hygiene",
    "subcategory": "grass",
    "images": ["images/125361,125362.webp"]
  },
  {
    "id": 395,
    "barcode": "125362",
...

{
    ...
    barcode: "",
    title: {
        ka: "WET MOP FRAME  BLUE",
        en: "WET MOP FRAME  BLUE",
        ru: "WET MOP FRAME  BLUE"
    },
    price: 6.95,
    inStock: true,
    category: "Household Goods",
    subcategory: "Floor",
    images: ["images/sameurneo2.jpg"]
},
...
const translations = {
    ...
    catBagi: "ჰიგიენა ბაგი",
        ...
        termsOrderRule4: "შეკვეთა განხორციელებულად ითვლება თქვენს მიერ ონლაინ რეგისტრაციის გავლისას მითითებულ ელექტრონულ ფოსტაზე ჩვენს მიერ დასტურის გამოგზავნის შემთხვევაში. შესაძლოა მარაგების არარსებობის/არასაკმარისი რაოდენობის გამო შემოთავაზებულ იქნას შეცვლილი პირობებით შეკვეთის გაფორმება.",
    ...
    catBagi: "Bagi Hygiene",
        ...
        termsOrderRule4: "The order is considered to be placed when we send a confirmation to the email address you provided during online registration. It is possible that due to lack of stock/insufficient quantity, you may be offered to place an order with changed terms.",
    ...
    catBagi: "Гигиена Bagi",
       ...
       barcodeLabel: "Штрихкод:",
        ...
        termsOrderRule4: "Заказ считается оформленным, когда мы отправляем подтверждение на адрес электронной почты, указанный вами при онлайн-регистрации. В связи с отсутствием товара на складе/недостаточным количеством, вам может быть предложено оформить заказ на измененных условиях.",
